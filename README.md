...
## Features
  ...
  * **DAPO-like Policy Optimization**: Implements a core group relative policy optimization loop to stably train the LLM from rewards.
...
4.  **Policy Update**: The experience (prompts, completions, old log-probabilities, and advantages) is passed to the `PolicyModelActor`. This actor uses DeepSpeed to perform several epochs of DAPO updates on the experience batch.
